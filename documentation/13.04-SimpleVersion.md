...
![The simplest version](../screenshots/13.04/simple_player.png)

![A simple asset for the player](../screenshots/13.04/adding_asset_for_player.png)

![Making a tilemap](../screenshots/13.04/simple_level_2.png)

(There I had a problem with the graphics)

![Fixing the tilemap and adding a better design](../screenshots/13.04/simple_level.png)
